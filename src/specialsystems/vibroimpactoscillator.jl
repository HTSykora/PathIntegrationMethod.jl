...
function (pcl::PreComputeNewtonStep)(vi_sde::SDE_VIO, method::DiscreteTimeStepping{<:ExplicitDriftMethod}, _x0, _x1, _t0, _t1) 
    ...
    _, xI_0bi! = build_function(x_new_bi, [x0, v0], [x1, v1], [xi, vi], par, r, t0, t1, ti, expression = Val{false})
    _, xI_0ai! = build_function(x_new_ai, [x0, v0], [x1, v1], [xi, vi], par, r, t0, t1, ti, expression = Val{false})
